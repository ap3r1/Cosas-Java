...
public class Practicas {
	...
	public boolean validarNif(String nif) {
		...
		int numerosOK;
		try {
			numerosOK = Integer.parseInt(numeros);//pasa cadena a int
		} catch (NumberFormatException e) {
			return false;
		}
		int resto = numerosOK % 23; //hayamos el modulo (resto de numerosok )
		if (letrasValidas[resto] != nif.charAt(8))//el resto nos hace de indice y se compara con el ultima letra del dni
			return false;
		return true;
	}
