...
public class Principal {
	...
	//	practicas.recorrerMatrizIrregularPorColumnas(matriz);
		...
		char resultado;
		Libro mislibros[];
		//resultado=mimetodo.dameLetraNif(000000001);
		//System.out.println(resultado);
		String[] libro= {"2#EL QUIJOTE DE LA MANCHA#16.25",
				"X#LOS PILARES DE LA TIERRA#18.50",
				"2#ODISEA EN EL ESPACIO#16.X",
				"5#LOS PILARES DE LA TIERRA#18.50"};
		mislibros=mimetodo.creaArrayLibro(libro);
		for (int i = 0; i < mislibros.length; i++) {
			/*if (mislibros[i]==null)
			System.out.println("nully");	
			 else {
			System.out.println(mislibros[i].getTitulo());
			}*/
		}
